import { DataProvider, useData } from "@/app/(dashboard)/components/DataContext";
        ...
        <header className=" container mx-auto py-1.5 columns-3 w-full">
            ...
            <DataProvider>
                <ul className="flex w-full columns-2 list-none justify-end">
                    ...
                    {userData.UserId == undefined ? <li className="flex justify-center items-center w-8 bg-white text-black rounded-full aspect-square"><Link className="h-max" href={'/login'}><i style={{lineHeight: "2"}} className="leading-loose fa-solid fa-user"></i></Link></li> : <li className="flex justify-center items-center w-8 bg-white text-black rounded-full aspect-square"><Link className="h-max" href={'/dashboard'}><i style={{lineHeight: "2"}} className="leading-loose fa-solid fa-user"></i></Link></li>}
                </ul>
            </DataProvider>
